...
__export(bundle_size_exports, {
  DELIMITER_WORD: () => DELIMITER_WORD,
  END_FLAG_WORD: () => END_FLAG_WORD,
  ERROR_IDENTIFIER: () => ERROR_IDENTIFIER,
  START_FLAG_WORD: () => START_FLAG_WORD,
  constructCommentMessage: () => constructCommentMessage,
  getDiffReport: () => getDiffReport,
  getFailedBundles: () => getFailedBundles,
  getSizeMap: () => getSizeMap,
  prettifyBundleSizeOutput: () => prettifyBundleSizeOutput,
  prettifyDiffReport: () => prettifyDiffReport,
  readReportsText: () => readReportsText,
  removeHashFromChunk: () => removeHashFromChunk
});
module.exports = __toCommonJS(bundle_size_exports);
var import_bytes = __toESM(require_bytes());
var DELIMITER_WORD = "----DELIMITER----";
var START_FLAG_WORD = "<<< START OF BUNDLESIZE OUTPUT >>>";
var END_FLAG_WORD = "<<< END OF BUNDLESIZE OUTPUT >>>";
var ERROR_IDENTIFIER = [
